...
/*! \file scr.h
 *  \brief Semi Conjugate Residual (SCR) method
 */
...
/*! \p scr : Semi Conjugate Residual method
 *
 ...
 *
 *  The following code snippet demonstrates how to use \p scr to 
...
/*! \p scr : Semi Conjugate Residual method
 *
 * Computes least squares solution of semi-definite linear system A x = b with the ability to specify the number of iterations for the recalculation of residual.
 */
template <class LinearOperator,
         class Vector,
         class Monitor,
...
#include <cusp/krylov/detail/scr.inl>
